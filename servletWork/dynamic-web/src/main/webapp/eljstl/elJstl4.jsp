...
<html>
<head>
<%--  httpL//localhost:8080/jstlLesson?action=function (forward)--%>
    <title>Title</title>
</head>
<body>
    <h1>function</h1>
    ...
    <p>Contains 'he' in 'hello': ${fn:contains('hello', 'he')}</p>
    <p>ContainsIgnoreCase 'HE' in 'hello': ${fn:containsIgnoreCase('hello', 'HE')}</p>
    <p>StartsWith 'he' in 'hello': ${fn:startsWith('hello', 'he')}</p>
